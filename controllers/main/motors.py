...
class SpotMotors:
    ...
    def __init__(self, robot, time_step):
        ...
        self.joint_max_velocity = np.array(
    ...
    def set_motor_positions(self, positions):
        ...
        epsilon = 1e-4 #0.000056 radianos de tolerancia para corrigir warnings de ponto flutuante

        safe_min = self.joint_min + epsilon
        safe_max = self.joint_max - epsilon

        positions = np.clip(positions, safe_min, safe_max)
